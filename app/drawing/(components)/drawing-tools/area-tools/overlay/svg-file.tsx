import { DrawSvg } from "@/utils/interface";
...
const SvgComponents: React.FC<SvgComponentsProps> = (props) => {
  if (props.drawSvg.svg === "triangle")
    return (
      <>
        <svg
          width="100%"
        ...
        >
          ...
          <image
            ...
            style={{
              ...(props.drawSvg.filter && {
                filter: `
               brightness(${props.drawSvg.filter.brightness}%)
               contrast(${props.drawSvg.filter.contrast}%)
               saturate(${props.drawSvg.filter.saturation}%)
               sepia(${props.drawSvg.filter.sepia}%)
               hue-rotate(${props.drawSvg.filter.hue}deg)
               blur(${props.drawSvg.filter.blur}px)
               grayscale(${props.drawSvg.filter.grayscale}%)
               invert(${props.drawSvg.filter.invert}%)
             `,
              }),
              transition: "300ms",
            }}
            x={`${props.drawSvg.crop.x}px`}
            y={`${props.drawSvg.crop.y}px`}
            width={props.drawSvg.crop.size}
            height={props.drawSvg.crop.size}
          ...
          <g id="SVGRepo_iconCarrier">
            ...
            <path
              ...
              stroke={props.drawSvg.borderColor}
              strokeWidth={props.drawSvg.thickness}
              style={{
                stroke: props.drawSvg.borderColor,
              }}
              strokeLinecap="round"
