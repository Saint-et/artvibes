...
const DrawingCropDisplay: React.FC<DrawingCropDisplayProps> = (props) => {
  useEffect(() => {
    ...
    try {
      ...
      image.onload = () => {
        ...
        //console.log(adjustedCropX);

        // console.log(props.isFreeAreaCrop);
        //console.log(adjustedCropX);
        ...
        //props.setCroppedImageUrlverification(false);
  ...
  if (!props.croppedImageUrl)
    return (
      ...
      >
        ...
        >
          Center
          <FaCompress className="h-3 w-3 ml-2" />
        </Button>
      </div>
    );
  ...
  return (
    <img
      className="object-contain w-full h-80 transition-transform duration-300 ease-in-out group-hover:scale-105"
